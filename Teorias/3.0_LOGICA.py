...
if nome == 'Paulo':
    ...
    # ESTRUTURA CONDICIONAL ANINHADA - ha varias condições/ramificações
...
for c in range(
        0, 5):  # contar de 0 - 4 - a variavel c funciona como um contador
    print(c)  # Irá printar 5 vezes pois está dentro do for
print('Fim')

for d in range(
        3, 0, -1):  # contar de trás para frente usa-se o 3º elemento negativo
    print(d)
...
for a in range(
        ...
        f +
        1,
        p):  # irá printar conforme as variaeis forem definidas
    print(a)
...
# =======WHILE
# FUNCIONA COMO FOR(USADO PARA REPETIR), MAS EM VEZ DE SER DETERMINADA
# PELO RANGE É DETERMINADA POR UMA CONDIÇÃO
